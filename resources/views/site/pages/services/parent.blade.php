...
@section('content')
    ...
    <section class="intro-section">
        <div class="section-bg">
            ...
            <img class="bg-img" src="{{asset('storage/app/services/thumbnail/full/').'/'.\App\Model\Attachments::find($Services->thumbnail)->path}}" alt="{{ $Services->title }}">
        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 technology">
                    <div class="services-include center">
                        <div class="heading base-color text-color text-uppercase">{{ $Services->title }}</div>
    ...
    <!-- Subset Services -->
    <section class="subset-services" style="background-image: url('{{ asset('public/assets/site/images/base') }}/subset-section-bg.jpg')">
        <div class="container">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="item">
                                <a href="{{ $item->slug }}" class="item-inner">
                                    <span class="icon"><img src="@if(isset(json_decode($item->service_meta, true)['icon_service'])){{asset('storage/app/services/service-icon').'/'.\App\Model\Attachments::find(json_decode($item->service_meta, true)['icon_service'])->path}}@endif" alt="{{ $item->title }}"></span>

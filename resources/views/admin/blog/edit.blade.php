                                ...
                                <div class="widget-content widget-content-padding">
                                    ...
                                    <div class="form-group">
                                        <div style="margin-bottom: 10px;">{!! Form::label('content_text','Post Content') !!}
                                            <span class="required">(Required)</span></div>
                                        <textarea class="field-style input-text" id="content_text" name="content_text" placeholder="Enter Post Content">{{ $Blog->content_text }}</textarea>
                        ...
                        <div class="heading-widget">
                            <div class="row align-items-center">
                                ...
                                <div class="col-2 left">
                                    <a target="_blank" href="{{ Url("blog/$Blog->slug") }}"><span class="icon"><img width="100%" src="{{ asset('public/assets/admin/img/base/icons/show.svg') }}"></span></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group row no-gutters">
                                ...
                                <div class="col-12 field-style custom-select-field">
                                    <div class="thumbnail-image-upload">
                                        <div>
                                            <label for="thumbnail-image" id="thumbnail-label" class="thumbnail-label"><img id="thumbnail-preview" src="@if($Blog->thumbnail && isset(\App\Model\Attachments::find($Blog->thumbnail)->path)) {{asset('storage/app/blog/thumbnail/636').'/'.\App\Model\Attachments::find($Blog->thumbnail)->path}} @else{{ asset('public/assets/admin/img/base/icons/image.svg') }}@endif"></label>

                                                        ...
                                                        <div class='text-field col-12' id='field-portfolio-item-{{ $Portfolio_count += 1 }}'>
                                                            <div class='row align-items-center'>
                                                                ...
                                                                <div class='col-10'>
                                                                    ...
                                                                    <span class='delete-row icon-close' onclick='delete_portfolio_item({{ $Portfolio_count }})'><img src='{{ asset('public/assets/admin/img/base/icons') }}/close.svg'></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endforeach
